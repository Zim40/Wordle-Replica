      ...
      <div className="game--abt-rules">
        {descriptionVisible && (
          <div>
            ...
            >
              ...
              puzzle game, decipher the 5-letter mystery word in just six
              attempts.
            </p>
          </div>
        )}
        {rulesVisible && (
          <div>
            ...
            >
              <li>Objective: Guess a five-letter word within six attempts.</li>
              <li>Guessing: Make valid English word guesses.</li>
              <li>Feedback: Colors indicate correct letters and positions.</li>
